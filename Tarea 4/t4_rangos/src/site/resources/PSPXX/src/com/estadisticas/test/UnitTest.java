...
public class UnitTest extends TestCase {
	...
	//archivo por defecto que se llamará para probar la lectura de archivo.
	...
	public void testCase1() throws Exception {
		...
		assertEquals("El cuarto valor de número de la lista debe ser 10.3333", (float)10.3333, testList.get(3).getValue(),delta);
        //Prueba sobre el cálculo de rangos, caso 1
	...
	setUpCase2();
		...
		assertEquals("El cuarto valor de número de la lista debe ser 12", 12, testList.get(3).getValue(),delta);
        //Prueba sobre el cálculo de rangos, caso 1

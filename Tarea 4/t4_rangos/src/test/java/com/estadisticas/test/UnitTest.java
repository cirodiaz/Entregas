...
/**
 * Clase de pruebas para el calculador de regresion lineal y correlacion.
...
public class UnitTest extends TestCase {
	...
	//archivo por defecto que se llamara para probar la lectura de archivo.
	final String DEFAULT_FILENAME = "C:\\tarea4\\archivoin.txt";
	/**
	 * Valores de prueba, basados en la tabla 1 de ejemplo del enunciado
	...
	/**
	 * Valores de prueba, basados en la tabla 2 de ejemplo del enunciado
	 * @throws java.lang.Exception
	 */
	...
	public void testCase1() throws Exception {
		...
		assertEquals("El cuarto valor de numero de la lista debe ser 10.3333", (float)10.3333, testList.get(3).getValue(),delta);
        //Prueba sobre el calculo de rangos, caso 1
	...
	setUpCase2();
		...
		assertEquals("El cuarto valor de numero de la lista debe ser 12", 12, testList.get(3).getValue(),delta);
        //Prueba sobre el calculo de rangos, caso 1
	...
	public void testReadFile() throws Exception {
		...
		testList = valArrayTest.readFromFile(DEFAULT_FILENAME);
		
		//Probar que la lista tenga elementos
		assertNotNull("Debe haber valores en la lista", testList.get(2).getValue());
		//Prueba de que los valores recopilados sean correctos.
		assertEquals("El cuarto valor de etiqueta de la lista debe ser each_line", "each_line", testList.get(3).getLabel());
		assertEquals("El cuarto valor de numero de la lista debe ser 10.3333", (float)10.3333, testList.get(3).getValue(),delta);
